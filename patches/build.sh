...
$CC $FLAGS -T ld.ld disable_erase_hash_standby_bank.S -o disable_erase_hash_standby_bank.elf || exit 1
$CC $FLAGS -T ld.ld disable_erase_hash_standby_bank.S -o disable_erase_hash_standby_bank.bin -Wl,--oformat=binary || exit 1
