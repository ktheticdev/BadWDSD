...
FUNC_DEF void Stage2()
{
...

    {
        ...
        {
            puts("Patching disable_erase_hash_standby_bank (ANTI BRICK)...\n");
            ...
            uint8_t replaceData[] = {0x38, 0x60, 0x00, 0x00, 0x4E, 0x80, 0x00, 0x20};

            if (!SearchAndReplace((void *)0x0, (16 * 1024 * 1024), searchData, 28, replaceData, 8))
            {
                puts("Patch failed!\n");
                dead_beep();
            }
...

        {
            ...
            uint8_t replaceData[] = {0x3C, 0x00, 0x00, 0x04, 0x78, 0x00, 0x07, 0xC6, 0xF8, 0x1C, 0x00, 0x00, 0x38, 0x9D, 0x00, 0x08};
